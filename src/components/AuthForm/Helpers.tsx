...
import { ANCHORS, ROUTES } from "@/utils/routes";
...
const NewUserNotification = (props: { closeSnackbar: () => void }) => {
  const user = useUser();
  return (
    <HorizontalStack addClassName="items-center">
      Welcome! Your username will be autogenerated. You can change it in your
      Profile page.
      <Link
        href={{
          pathname: ROUTES.private_myProfile,
          hash: ANCHORS.username,
        }}
        color="textPrimary"
        disabled={!user.data?.user?.id}
      >
        <Button
